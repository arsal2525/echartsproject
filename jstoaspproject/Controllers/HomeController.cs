...
using jstoaspproject.Models;
using Newtonsoft.Json;
using Microsoft.AspNetCore.Html;
using System;

namespace jstoaspproject.Controllers;
...
public class HomeController : Controller
{
    ...
    public ActionResult LoadChart(string freqopt,
        string dataContent,
        DateTime startDate,
        DateTime endDate,
        string chartId,
